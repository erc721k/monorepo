...
export interface PoolyPixelRenderInterface extends utils.Interface {
  contractName: "PoolyPixelRender";
  functions: {
...
export interface PoolyPixelRender extends BaseContract {
  contractName: "PoolyPixelRender";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyPixelRenderInterface;
