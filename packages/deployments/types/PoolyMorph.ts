...
export interface PoolyMorphInterface extends utils.Interface {
  contractName: "PoolyMorph";
  functions: {
...
export interface PoolyMorph extends BaseContract {
  contractName: "PoolyMorph";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyMorphInterface;
