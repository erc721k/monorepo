...
export interface PoolyNFTInterface extends utils.Interface {
  contractName: "PoolyNFT";
  functions: {
...
export interface PoolyNFT extends BaseContract {
  contractName: "PoolyNFT";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyNFTInterface;
