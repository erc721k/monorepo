...
export interface ExampleRenderInterface extends utils.Interface {
  contractName: "ExampleRender";
  functions: {
...
export interface ExampleRender extends BaseContract {
  contractName: "ExampleRender";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExampleRenderInterface;
