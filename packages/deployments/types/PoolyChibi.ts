...
export interface PoolyChibiInterface extends utils.Interface {
  contractName: "PoolyChibi";
  functions: {
    ...
    "preview(uint8)": FunctionFragment;
...
export interface PoolyChibi extends BaseContract {
  contractName: "PoolyChibi";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyChibiInterface;
  ...
  preview(position: BigNumberish, overrides?: CallOverrides): Promise<string>;
