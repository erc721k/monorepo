...
export interface PoolyChibiRenderInterface extends utils.Interface {
  contractName: "PoolyChibiRender";
  functions: {
...
export interface PoolyChibiRender extends BaseContract {
  contractName: "PoolyChibiRender";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyChibiRenderInterface;
